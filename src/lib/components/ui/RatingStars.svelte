...
>
	{#each Array(maxRating) as _, index}
		...
		<button
			type="button"
			class="relative {interactive ? 'cursor-pointer hover:scale-110 transition-transform' : 'cursor-default'} focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-1 rounded"
