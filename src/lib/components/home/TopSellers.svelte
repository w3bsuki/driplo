			...
			{#each topSellers.slice(0, 3) as seller, index}
				<button
					...
					class={cn(
						...
						"bg-white hover:bg-gradient-to-b hover:from-orange-50 hover:to-orange-100",
						"border border-orange-200 hover:border-orange-300 hover:shadow-lg"
					)}
				>
					<!-- Ranking Badge -->
					<div class={cn(
					...
					<!-- Avatar -->
					<div class="relative">
						<div class="w-12 h-12 rounded-full bg-gradient-to-br from-orange-400 to-orange-600 p-[2px] group-hover:from-orange-500 group-hover:to-orange-700 transition-all duration-300">
							<img 
					...
					<!-- Hover Effect -->
					<div class="absolute inset-0 bg-gradient-to-r from-orange-400/10 to-orange-600/10 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />
				</button>
			{/each}
		</div>
