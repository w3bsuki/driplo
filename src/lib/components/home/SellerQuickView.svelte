...
{#if isOpen && seller}
	...
	>
		...
		>
			<!-- Header -->
			<div class="relative bg-gradient-to-r from-orange-50 to-orange-100 p-6 pb-4">
				<button 
					onclick={close}
				...
				<div class="flex items-center gap-4">
					<div class="relative">
						<div class="w-16 h-16 rounded-full bg-gradient-to-br from-orange-400 to-orange-600 p-[2px]">
							<img 
			...
			<div class="p-6 space-y-6 overflow-y-auto">
				...
				<div class="grid grid-cols-3 gap-4">
					<div class="text-center">
						<div class="flex items-center justify-center w-10 h-10 bg-orange-100 rounded-full mb-2 mx-auto">
							<ShoppingBag class="h-5 w-5 text-orange-600" />
						</div>
						...
						<div class="grid grid-cols-2 gap-3">
							{#each topListings.slice(0, 3) as listing}
								<div class="bg-gray-50 rounded-xl p-3 hover:bg-gray-100 transition-colors cursor-pointer">
									...
									<div class="text-xs text-orange-600 font-semibold">{formatPrice(listing.price)}</div>
								</div>
							{/each}
						</div>
					</div>
			...
			<div class="p-6 pt-0 space-y-3">
				<button 
					onclick={viewStore}
					class="w-full bg-gradient-to-r from-orange-500 to-orange-600 text-white py-3 rounded-xl font-medium hover:from-orange-600 hover:to-orange-700 transition-all active:scale-95 flex items-center justify-center gap-2"
				>
				...
				<button 
					...
					class="w-full bg-white border border-orange-200 text-orange-600 py-3 rounded-xl font-medium hover:bg-orange-50 transition-all active:scale-95 flex items-center justify-center gap-2"
				>
