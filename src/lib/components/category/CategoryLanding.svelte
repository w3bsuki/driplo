<script lang="ts">
  ...
  let { category, subcategories, products = [], topSellers = [] }: Props = $props();
...
<section class="relative bg-gradient-to-b from-orange-50 to-white py-6 md:py-8">
  <div class="container px-4">
    <div class="max-w-3xl mx-auto">
            ...
            {#each topSellers.slice(0, 3) as seller, index}
              <a href="/profile/{seller.username}" class="text-center group">
                <div class="relative">
                  ...
                  {/if}
                  <div class="relative">
                    <div class="absolute inset-0 bg-gradient-to-r from-orange-400 to-orange-600 rounded-full blur opacity-20 group-hover:opacity-30 transition-all duration-300"></div>
                    <div class="relative w-16 h-16 md:w-20 md:h-20 rounded-full overflow-hidden ring-3 ring-white shadow-lg group-hover:ring-orange-200 transition-all duration-300">
      ...
      <div class="relative group">
        <div class="absolute inset-0 bg-gradient-to-r from-orange-400 to-orange-600 rounded-2xl blur-xl opacity-20 transition-all duration-300 group-focus-within:opacity-30 group-focus-within:blur-2xl"></div>
